...
export const getAllVideos = createAsyncThunk(
    ...
    async ({ userId, sortBy, sortType, query, page, limit }) => {
        try {
            ...
            console.log("Fetching from URL:", url.href); // Debugging
...
export const togglePublishStatus = createAsyncThunk(
    ...
    async (videoId) => {
        try {
            const response = await axiosInstance.patch( //http://localhost:8000/api/v1/video/toggle/publish/67ee216551b4949542a73b93
